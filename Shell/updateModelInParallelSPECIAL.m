function testCompletelyDone=updateModelInParallelSPECIAL
...
%length(questionModelMap.question_index)
%length(PKSforQuestionsCoveredByAdaptiveTest)
%proportionCorrectForTest
%proportionUncertain
%grv.modelHistory.SAsBeforeQ_TESTraw(1)
    ...
    if lrv.testMainDone==0
        ...
        nextQuestion=getTestQuestionForStudent(grv.studentHistory.question_index(end));
